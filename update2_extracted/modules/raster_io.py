...
# Public alias. Other modules (change_detection, sar_analysis) need box means
# for morphology and texture; they import this rather than reaching for the
# underscore-prefixed name.
def box_mean(a: np.ndarray, radius: int) -> np.ndarray:
    """Mean over a (2*radius+1)^2 window, edge-reflected."""
    return _box_mean(a, radius)
